    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2 col-12">
                <img width="110" src="./assets/logo.png" alt="logo" class="logo">
            </div>
            <div class="col-lg-4 col-12">
                <h4 class="font-rubik font-size-20">About</h4>
                <div class="d-flex flex-column flex-wrap">
                    <p class="font-size-14 font-rale text-white-50">
                        Football Booking thành lập năm 2025. Chúng tôi là nơi cho thuê sân bóng đá uy tín tại Việt Nam.
                    </p>
                </div>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; Copyrights 2025. Desing By <span class="color-second">Football Booking</span></p>
</div>
<!-- !start #footer -->
